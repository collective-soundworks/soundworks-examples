...
import SharedStateManagerClient from '@soundworks/core/common/SharedStateManagerClient.js';
...
(async function launch() {
  try {
    ...
    const clientStateManager = new SharedStateManagerClient(otherClientId, otherClientTransport);
